...
import { BarChart3, FileText, LogOut, PanelLeft, Plus, Settings, TrendingUp, Tag, Layers } from "lucide-react";
      ...
      <div className="flex items-center justify-center min-h-screen relative overflow-hidden">
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full relative z-10">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm font-light text-muted-foreground text-center max-w-sm tracking-wide">
              Track your trades, review your decisions, and improve your trading performance with data-driven insights.
            </p>
          </div>
          <Button
            onClick={() => {
